...
jQuery(document).ready(function() {
	TableDataForItemGroup.init();
	$("#masters_li").addClass("active");
	$("#masters_li").addClass("open");
	$("#item_group_li").addClass("active");
	updateGroup($("#itemDD").val());
});
function updateGroup(itemId) {
	if (itemId != undefined) {
		...
		$.ajax({
			url : contextURL + '/master/item-group/get-group-by-item',
			dataType : 'json',
			data : values,
...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="page-header">
				<h1>
					Manage Item Groups <small>View, edit, add, delete, tag groups</small>
				</h1>
			</div>
	...
	<c:choose>
		<c:when test="${showTagForm==true}">
			<div class="row" id="item_tag_form">
				<div class="col-sm-12">
					<!-- start: TEXT FIELDS PANEL -->
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-external-link-square"></i> Tag Item-Group
...
<!-- 								</a>  -->
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" method="post"
								action="<%=application.getContextPath()%>/master/item-group/tag">

								<div class="form-group">
									<label class="col-sm-2 control-label" for="form-field-2">
										Item </label>
									<div class="col-sm-4">
										<select class="form-control" name="itemId" id="itemDD"
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12 space20">
							...
							<a href="<%=application.getContextPath()%>/master/item-group/manageTag">
								<button class="btn btn-green">
									Tag Item-Group <i class="fa fa-plus"></i>
								</button>
							</a>
						</div>
					</div>
							...
							<table class="table table-striped table-hover" id="sample_2">
								...
								<c:forEach items="${groups}" var="group">
									<tr>
										...
										<td><a href="#" class="edit-row" id="${group.id}"> Edit </a></td>
										<td><a href="#" class="delete-row" id="${group.id}"> Delete </a></td>
									</tr>
								</c:forEach>	
								</tbody>
							</table>
