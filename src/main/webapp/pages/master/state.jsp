	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="page-header">
				<h1>
					Manage States <small>View, edit, add, delete states</small>
				</h1>
			</div>
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-external-link-square"></i>List of States
						...
						<div id="sample_2_wrapper" class="dataTables_wrapper form-inline"
							...
							<table class="table table-striped table-hover" id="sample_2">
								...
								<c:forEach items="${states}" var="state">
									<tr>
										<td>${state.name}</td>
										<td><a href="#" class="edit-row" id="${state.id}"> Edit </a></td>
										<td><a href="#" class="delete-row" id="${state.id}"> Delete </a></td>
									</tr>
								</c:forEach>	
								</tbody>
							</table>
